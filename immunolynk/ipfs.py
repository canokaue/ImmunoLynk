...
# PIN = "true" 
PIN = "false"
BASE_URL = "https://ipfs.infura.io:5001/api/v0/add?pin=" + PIN
READ_URL = "https://ipfs.infura.io:5001/api/v0/cat?arg="
DOWNLOADS_PATH = 'downloads/'

def upload_ipfs(file_path, file_type, cid):
    ...
    # Add metadata
    meta = dict(type = file_type, id = cid, timestamp = str(now))
...
if __name__ == '__main__':
    ...
    print(upload_ipfs('downloads/milos.jpg', 'JPG', 'Milos')) # greatest brazilian alive
